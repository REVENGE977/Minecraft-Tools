@echo off
title HanoRegedit Private Tool
color c
ping 127.0.0.1 -n 4 > nul
echo ExtroTech Team
echo 
echo.
echo ~HanoRegedit Private Tool
ping 127.0.0.1 -n 4 > nul
echo LOADING TOOL......
...
echo.
echo.
echo. 1 - POWER SETTINGS UPDATED                         
echo. 2 - MOUSE MOVEMENT UPDATED
echo. 3 - MEMORY SETTINGS UPDATED
echo. 4 - FPS SETTINGS UPDATED
echo. 5 - REGEDIT SETTINGS UPDATED
echo. 6 - WINDOWS SETTINGS UPDATED
echo. 7 - CPU PRIORITY UPDATED
echo. 8 - GPU SETTINGS UPDATED
echo. 9 - DNS SETTINGS UPDATED
echo. 10 - CONNECTION SETTINGS UPDATED
echo.
echo.
echo.
pause
